...
var name = "";
console.log("1NAME IS: " + name.value);
...
function game(cities, poly, iso, username) {
    ...
    cheat.onclick = function() {draw_cheat(city_latlng);}
        async function onMapClick(e) {
            ...
            console.log(lives);
            get_data_from_server("updatePlayedCity", name+"@"+city_name_$+"@"+iso+"@"+guess_flag);
            if (lives == 0) {
                var success_msg = document.getElementById("success_message");
                success_msg.style.color = "red";
                success_msg.innerHTML = "YOU FAILED";
                ...
                get_data_from_server("update_score", name+"@"+score);
                console.log("ONE")
